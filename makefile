...
build-all: build/pagerduty2slack

build/pagerduty2slack: FORCE
	go build $(GO_BUILDFLAGS) -ldflags '-s -w $(GO_LDFLAGS)' -o build/pagerduty2slack ./cmd
...
install: FORCE build/pagerduty2slack
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/pagerduty2slack "$(DESTDIR)$(PREFIX)/bin/pagerduty2slack"
...
help: FORCE
	...
	@printf "  \e[36mbuild/pagerduty2slack\e[0m  Build pagerduty2slack.\n"
